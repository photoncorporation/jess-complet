...
@media only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: landscape) and (-webkit-min-device-pixel-ratio: 1) {
  ...
  <?php include('./pages/menu_left.php'); ?>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <h5 style="color:black; font-weight:bold;"><i class="fas fa-list-alt" style="color:#18345D; font-size:15px;"></i><span style="color:#18345D;">  Consultances & Conseils</span></h5>                
                </div>
              </div>
              <div class="card-body">
                <div class="row">
