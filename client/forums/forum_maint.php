...
<script>
  ...
  //       }
        ...
        function sendMessage(e){
          ...
          const id = new URLSearchParams(window.location.search).get('id_service')
          ...
          const data = {
            contenu,
            id_service: id,
            id_user: saved_token.user.id,
            etat: "ce commentaire est acceptable"
          }
          fetch(`http://localhost:7000/api/v1/services/${id}/comment`,{
            method: "POST",
            headers: reqHeaders,
        ...
        function getMessages(){
          ...
          if(data.status === "success"){
            ...
            data.comments.forEach(message =>{
                  ...
                  console.log(message.User,"messag.contenu")
                  if(message.User.id == saved_token.user.id){
                    content.innerHTML += ` 
