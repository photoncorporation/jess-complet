  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="error-page">
        <h1 class="headline mt-4" style="color: #18345D; font-weight:bold;"> 404</h1>

        <div class="error-content mt-4">
          <h3 class="mt-4" style="color: #18345D; font-size:35px; font-weight:bold;"><i class="fas fa-exclamation-triangle" style="color:rgb(255,0,102);"></i> Oops! Page not found.</h3>

          <p style="font-size:25px;">
            We could not find the page you were looking for.
            Meanwhile, you may <a href="home">return to the home page</a> 
          </p>
        </div>
        <!-- /.error-content -->
      </div>
