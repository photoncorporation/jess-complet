        ...
        <div class="col-md-9">
            <div class="card">
              <div class="card-header">
               ...
               <label class="col-form-label" for="inputWarning" style="float: right;">Choisir une assistance</label> 
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <form action="#" method="post" onsubmit="post_demand(event)">
                    ...
                    <p>
                      <div class="form-group">                   
                          ...
                          <hr>
                          <p style="font-family: arial;font-size:15px;"><em>Veillez ajouter un commentaire avant d’envoer votre formulaire ; vous serez notifé dans 48h pour la suite du processus :</em></p>
...
<script>
  ...
  function post_demand(e){
    ...
    fetch(`https://jess-backend.onrender.com/api/v1/services/${id}/demande`,{
        method: "POST",
        headers: reqHeaders,
