              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="settings">
                    ...
                    <form class="form-horizontal" action="" method="PATCH"  onsubmit="updateService(event)" >
...
$(spn).attr({
 ...
 const service = (e) => {
  ...
  .then(service => {
    ...
    document.getElementById('name').value = service.services.name;
    document.getElementById('description').value = service.services.description;
