                  ...
                  <div class="active tab-pane" id="settings">
                    ...
                    <form class="form-horizontal" action="" method="POST"  onsubmit="service(event)" >
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Nom du service</label>
                        <div class="col-sm-10">
                          <input type="text" name="name" class="form-control" id="inputName" placeholder="service" required="">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Description</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputEmail" name="description" placeholder="Description" required=""></textarea>
                        </div>
                      </div>
            ...
            <div class="card">
             <div class="card-header">
              ...
              <div class="card-body">
                  ...
                  <tr>
                    <td style="color:black; font-size:16px;">1</td>
                    <td style="color:black; font-size:16px;"><a href="">photon</a></td>
                    <td style="color:black; font-size:16px;">photoncorporation@gmail.com</a></td>
                    <td style="color:black; font-size:16px;">Super Admin</td>
...
<script type="text/javascript">
 const service = (e) => {
  ...
  fetch("http://localhost:7000/api/v1/service", {
    ...
    res.json().then(res2 => {
      console.log(res2); 
      document.getElementById('err_msg').innerHTML = res2;
