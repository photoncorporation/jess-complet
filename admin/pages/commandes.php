...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        <div class="col-md-12">
            <div class="card">
              <h1 class="text-center mt-4" style="color:#18345D; font-weight: bold;">Liste de demandes de service </h1>
              <hr>
             <div class="card-header">
              ...
              <div class="card-body">
                  ...
                  <tr>
                    ...
                    <th style="color:#18345D; font-weight: bold;">Nom</th>
      ...
      const content = document.getElementById('content')
                    ...
                    res2.demandes.forEach((demande) => {
                      ...
                      tr.innerHTML = `
                            ...
                            <td style="color:black; font-size:16px;"><a href="">${demande.Service.name}</a></td>
                            ...
                            <td class="text-center">
                              <div class="d-flex justify-content-around">
                                ...
                                <a onclick="delete_service(${demande.id})" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                              </div>
                            </td>
                    `
                    // <a onclick="delete_service(${demande.id})" class="btn btn-danger"><i class="fas fa-trash"></i></a>
...
fetch(`https://jess-backend.onrender.com/api/v1/demandes/services/available/${id}`, {
  ...
  headers: reqHeaders,
  redirect: 'follow', // manual, *follow, error
  referrerPolicy: 'no-referrer', // no-referrer, *no-referrer-dwhen-downgrade, origin, origin-when-cross-origin, same-origin, strict-origin, strict-origin-when-cross-origin, unsafe-url
}).then(res => res.json())
.then(res2 => {
    if(res2.status === "success"){
